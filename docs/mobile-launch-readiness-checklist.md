...
| Map interaction | **Blocker** — native gestures and physical-device coverage incomplete | ISSUE-172 / PR #722; `docs/product-decisions.md` |
...
| QA-06 | Native map gestures pass on multiple physical devices | **Blocker** | ISSUE-172 final decision BLOCKED | ISSUE-172 / PR #722; `docs/product-decisions.md` | [ ] | Mobile QA |
